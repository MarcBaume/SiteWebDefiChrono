...
<form id="VerifEquipe" method="get" action="VerifEquipe.php">
	...
	<a href="admin/AddMembres.php"><img src="admin/images/addCoureur.jpg" width="60px" /></a>
...
<div id="InformationsCoureurs" style="display:none;">
	...
	<div id="HaveAChoiceCategorie"style="display:none">
		...
		<p id="lblNomEquipe" style="visibility:hidden; display:none"><label for="NomEquipe">Nom Equipe*:</label> <input type="text" name="NomEquipe" id="NomEquipe" tabindex="201"  onchange="EquipeChang(this.value)"   /></p>
