...
<?php
include("HeaderInscriptions.php");
?>
<script>
...
<input type="hidden" name="LastAdresseID" id="LastAdresseID"  value= '<?php echo?>' />
</form>
...
<div id="InformationsCoureurs">
	<h3> Formulaire d'inscription sur place v2: <?php echo  $NOM_COURSE .$ANNEE_COURSE ?>
	</h3>		
		<table width="100%">
