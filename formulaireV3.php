...
<img src="images/FilRougeInscription4.png" style="width: 100%" >
...
<?php if ($val ["JuraDefi"] )
{?>
	<p><label> Chef d'équipe : </label><Select   onchange ="ChoixCoureurs(this.form);" name="Coureur"   id="Coureur"/>  	<?
}
else
{
	?>
...
<div id="InformationsCoureurs" style="display:none;">
	...
	<div id="HaveAChoiceCategorie"style="display:none">
		<table id="TableEquipe" style="background: #D0D0D0; visibility:hidden; display:none;Width : 100%;">
			<tr style="Width : 100%;">
				<td >
				...
				if (typeof ParcoursObj != "undefined")
				{
					...
					if ((CatOBj.Equipe != null && CatOBj.Equipe.Value == true) || (CatOBj.Relais != null && CatOBj.Relais.Value == true))
					{
						...
						if (f.NomParcours.value == "TEAM")
						{
							...
							document.getElementById("ParaRemarques").style.display  = "block" ;
						}
