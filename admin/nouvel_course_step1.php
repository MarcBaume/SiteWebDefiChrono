...
if (parseInt( f.etape.value,10)>1){
       document.getElementById("NomEtape2").style.visibility = "visible";
       document.getElementById("DateEtape2").style.visibility = "visible";
	   document.getElementById("TxtNomEtape2").style.visibility = "visible";
       document.getElementById("TxtDateEtape2").style.visibility = "visible";
	   } 
if (parseInt( f.etape.value,10)>2){
	   document.getElementById("NomEtape3").style.visibility = "visible";
       document.getElementById("DateEtape3").style.visibility = "visible";
	   document.getElementById("TxtNomEtape3").style.visibility = "visible";
       document.getElementById("TxtDateEtape3").style.visibility = "visible";
	   }
if (parseInt( f.etape.value,10)>3){
	   document.getElementById("NomEtape4").style.visibility = "visible";
       document.getElementById("DateEtape4").style.visibility = "visible";
	   document.getElementById("TxtNomEtape4").style.visibility = "visible";
       document.getElementById("TxtDateEtape4").style.visibility = "visible";
	   }
	 if (parseInt( f.etape.value,10)>4){  
	   document.getElementById("NomEtape5").style.visibility = "visible";
       document.getElementById("DateEtape5").style.visibility = "visible";
	   document.getElementById("TxtNomEtape5").style.visibility = "visible";
       document.getElementById("TxtDateEtape5").style.visibility = "visible";
		}
}
</script>
<div id="corps">
<form method="post" action="script_ajout_course.php">
<ul id="step">
<fieldset>
