...
<?
	  include("HeaderInfo2022_dev.php"); 
	  ?>


<div id="corps"  style="position: absolut, margin 10px;padding :2%; margin-top: 250px" >
	 <!--- Couverture --->
	 <?php
...
{?>
 ...
 <p>  <b> Site Web :</b> <a target="_blank" href=<?php echo "http://www.". $val ["Site"] ?>><?php echo "www.". $val ["Site"] ?> </a></P>
